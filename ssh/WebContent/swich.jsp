		...
		<table height="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<tbody>
				<tr>
					...
					<td id="leftbar"
						style="display: none; background: url(images/main/switchbg.jpg) repeat-y #d2d2d0 0px 0">
					...
					<td id="rightbar"
						style="background: url(images/main/switchbg.jpg) repeat-y #f2f0f5 0px 0">
						<a onClick="switchSysBar()" href="javascript:void(0);"> <img
							src="images/main/pic23.jpg" width="12" height="72" border="0"
							alt="隐藏左侧菜单">
					</a>
					</td>
				</tr>
