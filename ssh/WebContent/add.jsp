					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">视频标题：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for">0</td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">视频封面：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for">留言测试</td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">上传视频：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for">留言测试</td>
						</tr>
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">选择操作：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input name=""
								type="submit" value="确定" class="text-but"> <input
